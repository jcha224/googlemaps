...
class MapNode implements Comparable<MapNode>
{
	...
	/**
	 * Return the distance to end node.
	 * @return the distance
	 */
	double getTotalDist() {
		if(end != null)
			return location.distance(end.location) + distance;
		else
			return distance;
	}
	...
	/**
	 * Sets new distance to start.
	 * @param dst the new distance
	 */
	void setDist(double dst) {
		distance = dst;
	}
	...
	public int compareTo(MapNode o) {
		...
		return Double.compare(getTotalDist(), o.getTotalDist());
	}
